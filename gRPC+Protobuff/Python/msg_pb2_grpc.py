...
class MsgStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getServerResponse = channel.unary_unary(
                ...
                request_serializer=msg__pb2.Message.SerializeToString,
...
def add_MsgServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getServerResponse': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=msg__pb2.Message.FromString,
                    response_serializer=msg__pb2.MessageResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'msg.Msg', rpc_method_handlers)
...
class Msg(object):
    ...
    def getServerResponse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/msg.Msg/getServerResponse',
            msg__pb2.Message.SerializeToString,
            msg__pb2.MessageResponse.FromString,
